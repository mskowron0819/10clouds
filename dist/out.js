...
document.addEventListener("DOMContentLoaded", function () {
    ...
    var btn = document.querySelector('#error button');
    // change color of gender radio input border
    for (var i = 0; i < gender.length; i++) {
        gender[i].addEventListener('change', function () {
            (function (radio) {
                var inputs = document.getElementsByName(radio.name);
                for (var _i = 0; _i < inputs.length; _i++) {
                    var pick = inputs[_i].checked ? '2px solid #1CD4A3' : '2px solid #c1c1c6';
                    inputs[_i].parentNode.style.border = pick;
                }
            })(this);
        });
    }
    ...
    var days = Array.from({ length: 31 }, function (v, k) {
        return k + 1;
    });
    days.map(function (a) {
        var opt = document.createElement('option');
    ...
    var years = Array.from({ length: 100 }, function (v, k) {
        return k + (currentYear - 116);
    });
    ...
    form.addEventListener("submit", function (event) {
        ...
        // gender validation
        var check = false;
        for (var _i2 = 0; _i2 < gender.length; _i2++) {
            if (gender[_i2].checked == true) {
                check = true;
            }
        }
        if (!check) {
        ...
        if (formValidation === true) {
            var div = document.querySelector("#success div");
            ...
            var _div = document.querySelector("#error div");
            allErrors.map(function (a) {
                var p = document.createElement("p");
                p.innerText = a;
                _div.appendChild(p);
                errorText.appendChild(_div);
...
// module
exports.push([module.i, "html, body, div, span, applet, object, iframe, h1, h2, h3, h4, h5, h6, p, blockquote, pre, a, abbr, acronym, address, big, cite, code, del, dfn, em, img, ins, kbd, q, s, samp, small, strike, strong, sub, sup, tt, var, b, u, i, center, dl, dt, dd, ol, ul, li, fieldset, form, label, legend, table, caption, tbody, tfoot, thead, tr, th, td, article, aside, canvas, details, embed, figure, figcaption, footer, header, hgroup, menu, nav, output, ruby, section, summary, time, mark, audio, video {\n  margin: 0;\n  padding: 0;\n  border: 0;\n  font-size: 100%;\n  font: inherit;\n  vertical-align: baseline; }\n\ninput {\n  border-radius: 0; }\n\nlegend {\n  white-space: nowrap; }\n\ninput[type=number]::-webkit-inner-spin-button,\ninput[type=number]::-webkit-outer-spin-button {\n  -webkit-appearance: none;\n  -moz-appearance: textfield;\n  margin: 0;\n  /* Removes leftover margin */ }\n\n::-webkit-input-placeholder {\n  /* Chrome/Opera/Safari */\n  color: #d9d9df; }\n\n::-moz-placeholder {\n  /* Firefox 19+ */\n  color: #d9d9df; }\n\n:-ms-input-placeholder {\n  /* IE 10+ */\n  color: #d9d9df; }\n\n:-moz-placeholder {\n  /* Firefox 18- */\n  color: #d9d9df; }\n\n/* HTML5 display-role reset for older browsers */\narticle, aside, details, figcaption, figure, footer, header, hgroup, menu, nav, section {\n  display: block; }\n\nol, ul {\n  list-style: none; }\n\nblockquote, q {\n  quotes: none; }\n\na {\n  text-decoration: none;\n  color: #000; }\n\nblockquote:before, blockquote:after {\n  content: '';\n  content: none; }\n\nq:before, q:after {\n  content: '';\n  content: none; }\n\ntable {\n  border-collapse: collapse;\n  border-spacing: 0; }\n\n* {\n  -webkit-box-sizing: border-box;\n  box-sizing: border-box; }\n\n@font-face {\n  font-family: 'liberation_sansregular';\n  src: url(" + __webpack_require__(13) + ") format(\"woff\");\n  font-weight: normal;\n  font-style: normal; }\n\nbody {\n  background-color: #242424;\n  height: 100vh;\n  overflow: hidden;\n  font-family: 'Liberation_sansregular'; }\n\n#app {\n  position: relative; }\n  #app .bg-left {\n    background: url(" + __webpack_require__(5) + ") no-repeat;\n    width: 900px;\n    height: 700px;\n    position: absolute;\n    top: 0;\n    left: 0;\n    z-index: -1;\n    -webkit-animation: scale 5s;\n    animation: scale 5s;\n    animation-fill-mode: forwards; }\n  #app .bg-right {\n    background: url(" + __webpack_require__(7) + ") no-repeat;\n    width: 994px;\n    height: 271px;\n    position: absolute;\n    bottom: 0;\n    right: 0;\n    z-index: -1;\n    -webkit-animation: move-left 3s;\n    animation: move-left 3s; }\n\n.container {\n  width: 90%;\n  margin: 0 auto;\n  display: -webkit-box;\n  display: -ms-flexbox;\n  display: flex;\n  -webkit-box-pack: center;\n  -ms-flex-pack: center;\n  justify-content: center;\n  height: 100vh; }\n  .container #main-content {\n    -ms-flex-item-align: center;\n    align-self: center;\n    width: 60%; }\n    .container #main-content h1 {\n      color: #FFFFFF;\n      font-size: 45px;\n      text-align: right;\n      padding: 0 125px 40px 0;\n      letter-spacing: 1px; }\n    .container #main-content .boxes {\n      height: 552px;\n      display: -webkit-box;\n      display: -ms-flexbox;\n      display: flex;\n      margin-bottom: 25px;\n      position: relative; }\n      .container #main-content .boxes:after {\n        content: '';\n        position: absolute;\n        top: -1px;\n        height: 2px;\n        width: 70px;\n        right: 45%;\n        background-color: #1BFEC0; }\n\n.box-left {\n  overflow: hidden;\n  width: 40%;\n  height: 100%; }\n  .box-left .box-left--animate {\n    background: url(" + __webpack_require__(8) + ") bottom center/cover no-repeat;\n    position: relative;\n    right: 0;\n    width: 100%;\n    height: 100%;\n    -webkit-animation: slide-right 1s;\n    animation: slide-right 1s; }\n  .box-left .lines {\n    background-color: rgba(26, 26, 26, 0.85);\n    position: absolute;\n    width: 100%;\n    height: 100%; }\n    .box-left .lines svg {\n      height: 100%;\n      width: 100%;\n      stroke-width: 2; }\n      .box-left .lines svg line {\n        stroke-dasharray: 400;\n        stroke-dashoffset: 400;\n        -webkit-animation: slide 2s 0.5s forwards;\n        animation: slide 2s 0.5s forwards; }\n\n.green {\n  stroke: #1CD4A3; }\n\n.purple {\n  stroke: #531FC0; }\n\n.white {\n  stroke: #FFFFFF; }\n\n.box-right {\n  overflow: hidden;\n  font-size: 14px;\n  width: 60%;\n  height: 100%; }\n  .box-right .box-right--animate {\n    background-color: #fbfbfd;\n    width: 100%;\n    height: 100%;\n    left: 0;\n    position: relative;\n    -webkit-animation: slide-left 1s;\n    animation: slide-left 1s; }\n  .box-right h2 {\n    width: 85%;\n    padding: 13% 13% 0 13%; }\n  .box-right form {\n    padding: 13%; }\n    .box-right form .label--style {\n      color: #c1c1c6;\n      font-size: 11px;\n      padding-left: 5%; }\n    .box-right form input, .box-right form select {\n      border: none;\n      margin-bottom: 5%;\n      border-bottom: 2px solid #c1c1c6;\n      outline: none;\n      background-color: transparent;\n      padding: 3% 0 5% 5%;\n      font-size: 16px; }\n      .box-right form input:focus, .box-right form select:focus {\n        border-color: #531FC0; }\n    .box-right form select {\n      border-radius: 0;\n      -webkit-appearance: none;\n      -moz-appearance: none;\n      padding: 3% 3% 5% 3%; }\n    .box-right form #name {\n      width: 100%; }\n    .box-right form #code {\n      width: 35%; }\n    .box-right form #phone {\n      width: 60%;\n      float: right; }\n    .box-right form .arrow {\n      position: relative; }\n      .box-right form .arrow:after {\n        content: '';\n        width: 0;\n        height: 0;\n        border-left: 4px solid transparent;\n        border-right: 4px solid transparent;\n        border-top: 4px solid #c1c1c6;\n        position: absolute;\n        top: 40%;\n        right: 5px; }\n\nform .radioBtn {\n  width: 47px;\n  height: 47px;\n  position: relative;\n  border: 2px solid #c1c1c6;\n  display: inline-block;\n  margin: 3% 9% 5% 0; }\n  form .radioBtn label {\n    width: 14px;\n    height: 14px;\n    position: absolute;\n    top: 15px;\n    right: -8px;\n    cursor: pointer;\n    background: #FFF;\n    border: 2px solid #c1c1c6;\n    padding: 0; }\n    form .radioBtn label:after {\n      content: '';\n      width: 3px;\n      height: 3px;\n      position: absolute;\n      top: 4px;\n      left: 4px;\n      background: #1CD4A3;\n      opacity: 0; }\n    form .radioBtn label:hover::after {\n      opacity: 0.3; }\n  form .radioBtn input[type=radio] {\n    visibility: hidden; }\n    form .radioBtn input[type=radio]:checked + label:after {\n      opacity: 1; }\n    form .radioBtn input[type=radio]:checked + label {\n      border: 2px solid #1CD4A3; }\n\nform .male {\n  background: url(" + __webpack_require__(10) + ") #FFFFFF no-repeat; }\n\nform .female {\n  background: url(" + __webpack_require__(9) + ") #FFFFFF no-repeat; }\n\nform #birth-info {\n  display: flex;\n  justify-content: space-between;\n  margin-top: 3%; }\n  form #birth-info span {\n    align-self: center;\n    transform: scale(3, 1);\n    color: #c1c1c6; }\n  form #birth-info option {\n    padding-left: 20px; }\n  form #birth-info #day, form #birth-info #month, form #birth-info #year {\n    height: 47px;\n    border: 2px solid #c1c1c6;\n    padding: 0 0 0 5%;\n    margin-bottom: 0; }\n  form #birth-info #day {\n    width: 47px;\n    text-align: center;\n    padding: 2%; }\n  form #birth-info #month, form #birth-info #year {\n    width: 33%; }\n\n.submit-btn {\n  color: #FFFFFF;\n  background: #a875eb;\n  background: -moz-linear-gradient(left, #a875eb 0%, #9459eb 21%, #8235e6 52%, #7c35e6 74%, #6c33e7 100%);\n  background: -webkit-gradient(left top, right top, color-stop(0%, #a875eb), color-stop(21%, #9459eb), color-stop(52%, #8235e6), color-stop(74%, #7c35e6), color-stop(100%, #6c33e7));\n  background: -webkit-linear-gradient(left, #a875eb 0%, #9459eb 21%, #8235e6 52%, #7c35e6 74%, #6c33e7 100%);\n  background: -o-linear-gradient(left, #a875eb 0%, #9459eb 21%, #8235e6 52%, #7c35e6 74%, #6c33e7 100%);\n  background: -ms-linear-gradient(left, #a875eb 0%, #9459eb 21%, #8235e6 52%, #7c35e6 74%, #6c33e7 100%);\n  position: absolute;\n  right: -50px;\n  bottom: -25px;\n  height: 50px;\n  width: 236px;\n  border: none;\n  line-height: 50px;\n  padding: 0;\n  overflow: hidden;\n  outline: none; }\n  .submit-btn #btn-arrow {\n    height: 50px;\n    width: 50px;\n    background-color: #7841F4;\n    display: block;\n    float: right;\n    -webkit-transition: background 2s;\n    transition: background 2s; }\n  .submit-btn:hover #btn-arrow {\n    background: #1CD4A3; }\n\n.btn-animation {\n  -webkit-animation: slide-btn 1s;\n  animation: slide-btn 1s; }\n\n#form-steps {\n  position: absolute;\n  width: 25px;\n  height: 200px;\n  right: -25px;\n  top: 30%; }\n  #form-steps .step {\n    height: 85px;\n    color: #555555;\n    padding: 10px;\n    font-size: 12px;\n    border-top: 2px solid #555555;\n    width: 100%;\n    display: block;\n    -webkit-animation: show 2s;\n    opacity: 0;\n    animation: show 2s 1s;\n    animation-fill-mode: forwards; }\n    #form-steps .step:nth-child(2) {\n      border-top: 2px solid #1CD4A3;\n      color: #FFFFFF; }\n\n#error, #success {\n  display: none; }\n\n#error.message, #success.message {\n  display: block;\n  position: absolute;\n  top: 0;\n  bottom: 0;\n  right: 0;\n  left: 0;\n  margin: auto;\n  width: 60%;\n  height: 50%;\n  text-align: center;\n  background-color: #FFFFFf;\n  border: 10px solid #1CD4A3;\n  display: flex;\n  justify-content: center; }\n  #error.message .submit-btn, #success.message .submit-btn {\n    right: 50%;\n    transform: translateX(50%);\n    width: 40%; }\n  #error.message div, #success.message div {\n    align-self: center; }\n    #error.message div p, #success.message div p {\n      margin: 2%;\n      color: #531FC0; }\n\n@media screen and (max-width: 768px) {\n  #app .bg-left {\n    background: url(" + __webpack_require__(4) + ") no-repeat;\n    background-size: 100%;\n    width: 100%;\n    height: 550px;\n    animation: show 3s; }\n  #app .bg-right {\n    background: url(" + __webpack_require__(6) + ") no-repeat;\n    width: 318px;\n    height: 110px; }\n  .hide-xs {\n    display: none; }\n  .container #main-content {\n    width: 100%;\n    height: 100%; }\n    .container #main-content h1 {\n      font-size: 30px;\n      padding: 10% 0 10% 0;\n      text-align: center; }\n    .container #main-content .boxes {\n      height: 77vh; }\n      .container #main-content .boxes:after {\n        right: 65%; }\n      .container #main-content .boxes .box-right {\n        width: 100%;\n        height: 77vh; }\n        .container #main-content .boxes .box-right .box-right--animate {\n          animation: slide-left paused; }\n        .container #main-content .boxes .box-right h2 {\n          font-size: 15px;\n          width: 100%;\n          padding: 10%; }\n        .container #main-content .boxes .box-right form {\n          padding: 5%; }\n  .container .submit-btn {\n    right: 50%;\n    transform: translateX(50%); } }\n\n@-webkit-keyframes move-left {\n  0% {\n    bottom: -40%;\n    right: -40%; }\n  100% {\n    bottom: 0;\n    right: 0; } }\n\n@keyframes move-left {\n  0% {\n    bottom: -40%;\n    right: -40%; }\n  100% {\n    bottom: 0;\n    right: 0; } }\n\n@-webkit-keyframes slide-left {\n  from {\n    left: -100%; }\n  to {\n    left: 0; } }\n\n@keyframes slide-left {\n  from {\n    left: -100%; }\n  to {\n    left: 0; } }\n\n@-webkit-keyframes slide-right {\n  from {\n    width: 0; }\n  to {\n    width: 100%; } }\n\n@keyframes slide-right {\n  from {\n    right: -100%; }\n  to {\n    right: 0; } }\n\n@-webkit-keyframes scale {\n  from {\n    background-size: 80%; }\n  to {\n    background-size: 100%; } }\n\n@keyframes scale {\n  from {\n    background-size: 80%; }\n  to {\n    background-size: 100%; } }\n\n@-webkit-keyframes slide-btn {\n  from {\n    height: 0; }\n  to {\n    width: 50px; } }\n\n@keyframes slide-btn {\n  from {\n    height: 0; }\n  to {\n    height: 50px; } }\n\n@-webkit-keyframes slide {\n  to {\n    stroke-dashoffset: 0; } }\n\n@keyframes slide {\n  to {\n    stroke-dashoffset: 0; } }\n\n@-webkit-keyframes show {\n  from {\n    opacity: 0; }\n  to {\n    opacity: 1; } }\n\n@keyframes show {\n  from {\n    opacity: 0; }\n  to {\n    opacity: 1; } }\n", ""]);
...
module.exports = __webpack_require__.p + "src/img/bg-left-mobile.png";
...
module.exports = __webpack_require__.p + "src/img/bg-right-mobile.png";
...
module.exports = __webpack_require__.p + "src/img/female.png";
